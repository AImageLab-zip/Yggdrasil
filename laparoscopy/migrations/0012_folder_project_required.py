...
(0010_folders_to_projects) could backfill it, and it stayed nullable afterwards.
That left the field optional in every ModelForm -- including the Django admin's
"add folder" page -- so a folder could still be created with no project at all.
Such a folder is invisible in every project-scoped listing (patient list, upload,
export) while remaining reachable by id.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("laparoscopy", "0011_laparoscopyproject"),
