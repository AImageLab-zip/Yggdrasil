(function () {
    ...
    function injectStyles() {
        ...
        style.textContent = [
            ...
            '.lap-tour-card{position:fixed;z-index:2050;width:min(360px,calc(100vw - 28px));background:var(--ygg-surface);border:1px solid var(--ygg-border);border-radius:var(--ygg-radius-lg);box-shadow:var(--ygg-shadow-card);padding:1rem;color:var(--ygg-text);}',
            '.lap-tour-card h5{font-size:1rem;margin:0 0 .35rem;font-weight:700;color:var(--ygg-text);}',
            '.lap-tour-card p{font-size:.9rem;margin:0;color:var(--ygg-text-muted);line-height:1.45;}',
            '.lap-tour-progress{font-size:.76rem;color:var(--ygg-text-muted);font-weight:600;letter-spacing:.03em;text-transform:uppercase;}',
            ...
            '.lap-tour-next{background:var(--ygg-primary-hover)!important;border:1px solid var(--ygg-primary-hover)!important;color:var(--ygg-on-primary)!important;font-weight:700;}',
            '.lap-tour-next:hover{background:var(--ygg-primary-hover)!important;border-color:var(--ygg-primary-hover)!important;color:var(--ygg-on-primary)!important;box-shadow:0 0 0 3px var(--ygg-primary-soft);}',
            '.lap-tour-next:focus-visible{outline:3px solid var(--ygg-primary-soft);outline-offset:2px;}',
    ...
    function render(tour) {
        ...
        tour.card.innerHTML = [
            ...
            '<button type="button" class="btn btn-sm lap-tour-next" data-tour-next>', tour.index === tour.steps.length - 1 ? 'Done' : 'Next', '</button>',
            '</div>',
            '</div>'
        ].join('');
