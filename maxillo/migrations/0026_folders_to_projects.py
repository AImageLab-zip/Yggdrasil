"""Data migration: folders become Projects (maxillo).
...
wins). Domain catch-all project (slug 'maxillo') absorbs patients with no
folder.
"""
...
def forwards(apps, schema_editor):
    ...
    FolderAccess = apps.get_model("maxillo", "FolderAccess")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("maxillo", "0025_alter_folder_unique_together_folder_project_and_more"),
