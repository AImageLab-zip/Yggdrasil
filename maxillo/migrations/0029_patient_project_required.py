...
Companion to 0028_folder_project_required, which did the same for folders.
``Patient.project`` was added as nullable so 0026_folders_to_projects could
...
* a patient that already has a folder takes **that folder's** project, since the
  ...
  0028_folder_project_required); assigning the catch-all instead would leave the
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("maxillo", "0028_folder_project_required"),
